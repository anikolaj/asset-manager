...
class Equity:
    ...
    def __repr__(self) -> str:
        return f"Equity(ticker={self.ticker}, shares={self.shares}, " \
...
class Valuation:
    ...
    def __repr__(self) -> str:
        return f"Valuation(current_value={self.current_value}, ytd={self.ytd}, " \
...
class Trade:
    ...
    def __repr__(self) -> str:
        return f"Trade(ticker={self.ticker}, price={self.price}, shares={self.shares}, execution_time={self.execution_time})"
...
class Portfolio:
    ...
    def __repr__(self) -> str:
        return f"Portfolio(id={self.id}, name={self.name}, value={self.value}, cash={self.cash}, " \
               f"equities={'[..]' if len(self.equities) != 0 else '[]'}, trades={'[..]' if len(self.equities) != 0 else '[]'}), " \
